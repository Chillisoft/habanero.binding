...
namespace Habanero.Binding.Tests
{
    ...
    public class TestBindingListView
    {
        ...
        public void Test_Construct_WhenBusinessObjectCollectionIsNull_ShouldRaiseError()
        {
            ...
            try
            {
                var bindingListView = new BindingListView<FakeBO>(null);
        ...
        public void Test_DetermineFilterOperator_WhenEquals_ShouldGetFilterOperator()
        {
            ...
            //---------------Test Result -----------------------
            Assert.AreEqual(filterOperator, FilterOperator.EqualTo);
        }
        ...
        public void Test_DetermineFilterOperator_WhenGreaterThan_ShouldGetFilterOperator()
        {
            ...
            FilterOperator filterOperator = bindingListView.DetermineFilterOperator("FakeBO>'SomeStuff'");
            //---------------Test Result -----------------------
            Assert.AreEqual(filterOperator, FilterOperator.GreaterThan);
        }
        ...
        public void Test_DetermineFilterOperator_WhenLessThan_ShouldGetFilterOperator()
        {
            ...
            FilterOperator filterOperator = bindingListView.DetermineFilterOperator("FakeBO<'SomeStuff'");
            //---------------Test Result -----------------------
            Assert.AreEqual(filterOperator, FilterOperator.LessThan);
        }
        ...
        public void Test_DetermineFilterOperator_WhenNoOperator_ShouldReturmNoneFilterOperator()
        {
            ...
            FilterOperator filterOperator = bindingListView.DetermineFilterOperator("FakeBO<>'SomeStuff'");
            //---------------Test Result -----------------------
            Assert.AreEqual(filterOperator, FilterOperator.None);
        }
        ...
        public void Test_CopyTo_WhenArrayIndexLessThanZero_ShouldArgumentOutOfRangeException()
        {
            ...
            {
                StringAssert.Contains("Number was less than the array's lower bound in the first dimension", ex.Message);
            }
        }
        ...
        public void Test_CopyTo_WhenArrayIndexGreaterThanArrayLength_ShouldArgumentException()
        {
            ...
            {
                StringAssert.Contains("Destination array was not long enough. Check destIndex and length, and the array's lower bounds", ex.Message);
            }
        }
        ...
        public void Test_CopyTo_WhenColHas3Objets_ShouldCopyObjectsToArray()
        {
            ...
            //---------------Test Result -----------------------
            Assert.IsNull(array[0], "Should be null because this is being copied to from index 1");
            Assert.IsNotNull(array[1], "Should not be null since this is being copied to from index 1");
        }
