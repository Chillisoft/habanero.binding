...
{
    [TestFixture]
    public class TestDateTimePickerMapperWinForms
    {
        [TestFixtureSetUp]
        ...
        {
            //---------------Set up test pack-------------------
            var mapper = new DateTimePickerMapperWin(GenerateStub<DateTimePicker>(), "FakeDateProp", false, GlobalUIRegistry.ControlFactory);
